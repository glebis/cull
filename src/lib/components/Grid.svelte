<script lang="ts">
    ...
    import { images, selectedIds, selectionAnchorIndex, focusedIndex, thumbnailSize, viewMode, gridGap, gridScrollTop, navigateTo, imageLoadState, showToast, totalCount, folders, gridPreset, GRID_PRESETS, activeCollection, clipboardMonitorStatus } from '$lib/stores';
...
>
    ...
    {:else if libraryViewState === 'empty' && isClipboardMonitorEmpty}
