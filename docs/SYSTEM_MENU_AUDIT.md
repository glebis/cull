...
| Help menu | Pass | Cull User Guide opens the bundled native macOS Help Book. |
...
| Label | Shortcut | Native ID / Event | Handler | Status |
|---|---|---|---|---|
| Cull User Guide | none | `help` | Opens the bundled `Cull.help` Apple Help Book in Help Viewer | Pass |
...
- Help opens the task-oriented Cull User Guide as a bundled native macOS Help Book instead of the repository README.
