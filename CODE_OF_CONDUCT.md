...
Cull contributors are expected to keep project discussion direct, specific, and respectful.
...
- Respect privacy. Do not post private image paths, API keys, tokens, logs with personal data, or unreleased user material.
...
Report conduct issues to `glebis@gmail.com`.
