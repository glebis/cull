...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::selection_run::preview_selection_source,
            commands::selection_run::create_selection_run,
            commands::selection_run::list_selection_runs,
            commands::selection_run::get_selection_run,
            commands::selection_run::list_selection_source,
            commands::selection_run::list_selection_shortlist,
            commands::selection_run::add_to_shortlist,
            commands::selection_run::remove_from_shortlist,
            commands::selection_run::finish_selection_run,
            commands::selection_run::reopen_selection_run,
            commands::selection_run::archive_selection_run,
            commands::selection_run::restore_selection_run,
            ...
            commands::detection::list_image_ids_missing_detection,
            ...
            commands::vision::list_image_ids_missing_vision,
